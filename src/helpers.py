...
def make_my_information() -> Panel:
    ...
    sponsor_message.add_row("")
    sponsor_message.add_row(
        "[u bright_blue link=https://twitter.com/joy_7383/]Twitter : https://twitter.com/joy_7383/"
    )
    sponsor_message.add_row("")
    sponsor_message.add_row(
        "[u bright_blue link=https://instagram.com/avnshrathod/]Instagram : https://twitter.com/avnshrathod/"
    )
    sponsor_message.add_row("")
    message_panel = Panel(
        Align.center(
...
def make_sponsor_message() -> Panel:
    ...
    sponsor_message.add_row("")
    sponsor_message.add_row(
        "[u bright_blue link=https://github.com/Avnsh1111/Instagram-Reels-Scraper-Auto-Poster]Github : https://github.com/Avnsh1111/Instagram-Reels-Scraper-Auto-Poster"
    )
